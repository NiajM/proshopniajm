...
const ProductEditScreen = ({ match, history }) => {
    ...
    const uploadFileHandler = async (e) => {    // async is for http request
        ...
        try {
            const config = {
                headers: {
                    'Content-Type': 'multipart/form-data'   //This is must important to uploading image
                }
            }
    ...
    const submitHandler = (e) => {
        ...
        dispatch(updateProduct({ _id: productId, name, image, brand, category, description, price, countInStock }))
    }
