...
const RegisterScreen = ({ location, history }) => {
    ...
    const userRegister = useSelector(state => state.userRegister)	// This state.userRegister->userRegister is from store.js (const reducer) (userRegister: userRegisterReducer)
